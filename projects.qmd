...
::: {.card style="padding:15px; border-radius:10px; box-shadow:0 1.5px 6px var(--accent); text-align:center;"}
![](assets/_project_pictures/_bt_ra.jpg){style="width:100%; border-radius:8px; margin-bottom:10px;"}
...
[Research Analysis](assets/_projects/_research_analysis.pdf){.btn .btn-accent .btn-sm}
:::
...
[ML Essay →](assets/_projects/ml_ca.pdf){.btn .btn-accent .btn-sm}
:::
...
[Python Code →](python_code.qmd){.btn .btn-accent .btn-sm}
:::
...
[Business Plan →](assets/_projects/_business_plan.pdf){.btn .btn-accent .btn-sm}
:::
